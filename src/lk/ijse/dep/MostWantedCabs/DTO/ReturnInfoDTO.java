...
public class ReturnInfoDTO {
    ...
    public ReturnInfoDTO(Date issueDate, Date returnDate, String issueId, String additionalKilometers, double costOfDamage, String vehicleModel, String customerModel, double total) {
